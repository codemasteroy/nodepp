...
var FicoraExtension = require('../lib/ficora-extension.js');
...
EppFactory.generate = function(registry, config) {
    ...
    config.extensionClasses.forEach(function(extensionClass) {
        ...
        case 'HexonetExtension':
            ...
            break;
        case 'FicoraExtension':
            mixer = FicoraExtension;
            logger.debug("Applying ficora mixin");
            mapper = FicoraExtension.mixinMapper();
            break;
        default:
        }
